<x-app-layout>
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Daftarkan karyawan baru dengan akses yang sesuai</p>
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-4xl">
        <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data" x-data="employeeForm()">
            @csrf

            <!-- Basic Info Card -->
            <x-ui.card title="Informasi Karyawan" description="Data dasar karyawan" class="mb-6">
            ...
            <!-- Capabilities Card -->
            <x-ui.card title="Hak Akses" description="Pilih kemampuan yang diberikan kepada karyawan ini" class="mb-6">
                <!-- Role Presets -->
                <div class="mb-6">
    ...
    <script>
        ...
        function employeeForm() {
            return {
                selectedCapabilities: @json(old('capabilities', ['dashboard'])),
                activePreset: 'cashier',
