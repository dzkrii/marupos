    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="600">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-lg">
                Temukan jawaban untuk pertanyaan umum tentang RestoZen
            </p>
        </div>
        ...
        <div x-data="{ activeIndex: 0 }" class="space-y-4" data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">
            ...
            <div class="border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
                ...
                <div x-show="activeIndex === 3" x-collapse>
                    <div class="p-5 bg-white dark:bg-gray-950 text-gray-600 dark:text-gray-400">
                        RestoZen adalah aplikasi web-based yang membutuhkan koneksi internet. Namun, kami sedang mengembangkan mode offline untuk transaksi dasar yang akan segera tersedia. Data akan di-sync otomatis saat online kembali.
                    </div>
                </div>
            </div>
        ...
        <div class="mt-12 text-center p-8 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800" data-aos="fade-up" data-aos-duration="600">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="mailto:support@restozen.id" class="inline-flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl font-medium text-gray-700 dark:text-gray-300 hover:border-brand-500 hover:text-brand-500 transition-all shadow-theme-xs">
