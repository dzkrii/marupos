...
<head>
    ...
    <title>{{ $title ?? 'Admin Dashboard' }} | RestoZen Admin</title>
...
<body
    ...
    >
        <div class="h-16 w-16 animate-spin rounded-full border-4 border-solid border-error-500 border-t-transparent"></div>
    </div>
