                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="restaurant_name" name="restaurant_name" value="{{ old('restaurant_name') }}" required
                                        placeholder="Masukkan nama restoran/outlet"
                                        class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                    ...
                    <div class="flex max-w-sm flex-col items-center px-8">
                        ...
                        <div class="mt-8 space-y-3">
                            <div class="flex items-center gap-3 text-gray-300">
                                <svg class="size-5 text-success-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                <span class="text-sm">Manajemen pesanan real-time</span>
                            </div>
                            <div class="flex items-center gap-3 text-gray-300">
                                <svg class="size-5 text-success-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                <span class="text-sm">Kitchen Display System</span>
                            </div>
                            <div class="flex items-center gap-3 text-gray-300">
                                <svg class="size-5 text-success-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                <span class="text-sm">Laporan penjualan lengkap</span>
                            </div>
                        </div>
                    </div>
                </div>
